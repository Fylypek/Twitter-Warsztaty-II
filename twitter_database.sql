...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`tweetId`) REFERENCES `tweets` (`id`) ON DELETE CASCADE
...
CREATE TABLE `messages` (
  ...
  CONSTRAINT `messages_ibfk_2` FOREIGN KEY (`recipientId`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-05-12 20:15:25
